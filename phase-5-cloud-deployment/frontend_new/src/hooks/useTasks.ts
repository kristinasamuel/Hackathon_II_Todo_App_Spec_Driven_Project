...
export const useTasks = () => {
  ...
  const addTask = async (taskData: NewTask) => {
    try {
      ...
      // After successful creation, refetch tasks to ensure consistency with backend
      // This addresses the issue where tasks don't appear immediately due to DAPR delays
      await fetchTasks();
